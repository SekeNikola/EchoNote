...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notes` (`id`,`serverId`,`title`,`snippet`,`transcript`,`audioPath`,`imagePath`,`highlights`,`isFavorite`,`isArchived`,`createdAt`,`reminderTime`,`checklistState`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getChecklistState() == null) {
          ...
          statement.bindString(13, entity.getChecklistState());
        }
      }
    };
    ...
    this.__updateAdapterOfNote = new EntityDeletionOrUpdateAdapter<Note>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `notes` SET `id` = ?,`serverId` = ?,`title` = ?,`snippet` = ?,`transcript` = ?,`audioPath` = ?,`imagePath` = ?,`highlights` = ?,`isFavorite` = ?,`isArchived` = ?,`createdAt` = ?,`reminderTime` = ?,`checklistState` = ? WHERE `id` = ?";
      }
      ...
      public Note call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new Note(_tmpId,_tmpServerId,_tmpTitle,_tmpSnippet,_tmpTranscript,_tmpAudioPath,_tmpImagePath,_tmpHighlights,_tmpIsFavorite,_tmpIsArchived,_tmpCreatedAt,_tmpReminderTime,_tmpChecklistState);
          } else {
            _result = null;
          }
          return _result;
        ...
        try {
          ...
          try {
            ...
            if (_cursor.moveToFirst()) {
              ...
              _tmpNote = new Note(_tmpId,_tmpServerId,_tmpTitle,_tmpSnippet,_tmpTranscript,_tmpAudioPath,_tmpImagePath,_tmpHighlights,_tmpIsFavorite,_tmpIsArchived,_tmpCreatedAt,_tmpReminderTime,_tmpChecklistState);
  ...
  @Override
  public Object getAllNotesOnce(final Continuation<? super List<Note>> arg0) {
  ...
  private void __fetchRelationshipnotesAscomExampleAppDataNote(
    ...
    try {
      // _junction.noteId;
      final int _itemKeyIndex = 13;
      if (_itemKeyIndex == -1) {
        return;
      }
      final int _cursorIndexOfId = 0;
      final int _cursorIndexOfServerId = 1;
      final int _cursorIndexOfTitle = 2;
      final int _cursorIndexOfSnippet = 3;
      final int _cursorIndexOfTranscript = 4;
      final int _cursorIndexOfAudioPath = 5;
      final int _cursorIndexOfImagePath = 6;
      final int _cursorIndexOfHighlights = 7;
      final int _cursorIndexOfIsFavorite = 8;
      final int _cursorIndexOfIsArchived = 9;
      final int _cursorIndexOfCreatedAt = 10;
      final int _cursorIndexOfReminderTime = 11;
      final int _cursorIndexOfChecklistState = 12;
      while (_cursor.moveToNext()) {
        final long _tmpKey;
        ...
        if (_tmpRelation != null) {
          ...
          _item_1 = new Note(_tmpId,_tmpServerId,_tmpTitle,_tmpSnippet,_tmpTranscript,_tmpAudioPath,_tmpImagePath,_tmpHighlights,_tmpIsFavorite,_tmpIsArchived,_tmpCreatedAt,_tmpReminderTime,_tmpChecklistState);
