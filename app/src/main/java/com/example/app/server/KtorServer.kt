...
object KtorServer {
    ...
    private fun getCurrentTimestamp(): String = Date().toInstant().toString()
    ...
    suspend fun start() {
        embeddedServer(Netty, host = "0.0.0.0", port = 8080) {
            ...
            install(WebSockets) {
                pingPeriodMillis = 15000L // 15 seconds in milliseconds
                timeoutMillis = 15000L    // 15 seconds in milliseconds
